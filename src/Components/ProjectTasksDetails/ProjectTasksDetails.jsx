...
const ProjectTasksDetails = ({ borderColor, taskCount, handleNavigate, statusTitle }) => {
    ...
    return (
      <div 
        className={`w-48 h-20 bg-white border-b-[12px] ${borderColor} flex flex-col items-center p-3 hover:shadow-lg hover:-translate-y-1 cursor-pointer relative group transition-transform overflow-hidden`} 
